"""
Kubernetes Platform Adapter — PLAN_ONLY stub.

Full Kubernetes platform adapter to be implemented in Phase 2+.
"""
...
class KubernetesPlatformAdapter(PlatformAdapter):
    """Kubernetes Platform Adapter — PLAN_ONLY stub."""
    ...
    async def deploy(self, target: ExecutionTarget, manifest: dict[str, Any]) -> dict[str, Any]:
        return {"status": "NOT_IMPLEMENTED", "note": "Kubernetes adapter: PLAN_ONLY stub"}
